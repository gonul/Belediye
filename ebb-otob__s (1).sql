...
--
-- Anamakine: localhost
-- Üretim Zamanı: 17 Ara 2013, 22:13:45
...
--
-- Veritabanı: `ebb-otobüs`
--
CREATE DATABASE IF NOT EXISTS `ebb-otobüs` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `ebb-otobüs`;
...
INSERT INTO `geneldurum` (`GBaglac`, `GBasDk`, `GBitDk`, `Belirtec`, `GID`, `OtoID`) VALUES
(1, '30', '30', '1S06', 1, 1),
(1, '45', '50', '1S06', 2, 1),
(1, '00', '05', '1S07', 3, 1),
(1, '15', '20', '1S07', 4, 1),
...
--
-- Tablo için tablo yapısı `güzergah`
--

CREATE TABLE IF NOT EXISTS `güzergah` (
  ...
  `DönüsAraDurak` varchar(1000) CHARACTER SET utf8 COLLATE utf8_turkish_ci NOT NULL,
  `GidisAraDurak` varchar(10000) CHARACTER SET utf8 COLLATE utf8_turkish_ci NOT NULL,
  PRIMARY KEY (`GuzergahID`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Tablo döküm verisi `güzergah`
--

INSERT INTO `güzergah` (`GuzergahID`, `BasNok`, `BitNok`, `DönüsAraDurak`, `GidisAraDurak`) VALUES
...
--
-- Tablo için tablo yapısı `otobüs`
--

CREATE TABLE IF NOT EXISTS `otobüs` (
  `Renk` varchar(100) NOT NULL,
  `No` varchar(100) NOT NULL,
  `OtobüsID` int(100) NOT NULL,
  `GüzergahID` int(11) NOT NULL,
  PRIMARY KEY (`OtobüsID`),
  UNIQUE KEY `OtobüsID` (`OtobüsID`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Tablo döküm verisi `otobüs`
--

INSERT INTO `otobüs` (`Renk`, `No`, `OtobüsID`, `GüzergahID`) VALUES
('siyah', '1', 1, 1),
('siyah', '2', 2, 2),
('kirmizi', '2', 3, 3),
('siyah', '3', 4, 4),
...
CREATE TABLE IF NOT EXISTS `zaman` (
  `saat` time NOT NULL,
  `baglaç` int(11) NOT NULL,
  `OtobüsID` int(11) NOT NULL,
...
--
-- Tablo için tablo yapısı `özeldurum`
--

CREATE TABLE IF NOT EXISTS `özeldurum` (
  `OBaglac` int(11) NOT NULL,
...
--
-- Tablo döküm verisi `özeldurum`
--

INSERT INTO `özeldurum` (`OBaglac`, `OBasDk`, `OBitDak`, `Belirtec`, `OID`, `Tarih`, `OtoID`) VALUES
